      ...
      <div className="mx-auto p-6 h-16 flex items-center justify-between w-full">        
        ...
        <div className="hidden md:flex items-center gap-4">
          <button
            ...
            className="flex items-center justify-center gap-2 text-sm text-white border border-white rounded-xl px-4 py-2 hover:bg-white/10 transition-all focus:ring-2 focus:ring-white/20 whitespace-nowrap"
          >
